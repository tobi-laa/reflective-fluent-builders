...
class GeneratedAnnotationCodeGeneratorTest {
    ...
    void testGenerate() {
        ...
        // Assert
        assertThat(actual).hasToString("@javax.annotation.Generated(value = \"io.github.tobi.laa.reflective.fluent.builders.generator.api.JavaFileGenerator\", date = \"3333-03-13T00:00Z[UTC]\")");
    }
}